...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='sketch', help='name of the experiment. It decides where to store samples and models')
        ...
        parser.add_argument('--crop_size', type=int, default=480, help='Crop to the width of crop_size (after initially scaling the images to load_size.)')
        ...
        parser.add_argument('--input_nc', type=int, default=21, help='# of input image channels')
